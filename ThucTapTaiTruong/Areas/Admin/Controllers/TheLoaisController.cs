...
namespace ThucTapTaiTruong.Areas.Admin.Controllers
{
    public class TheLoaisController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "MaTheLoai,TenTheLoai,DoUuTien,TrangThai")] TheLoai theLoai)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "MaTheLoai,TenTheLoai,DoUuTien,TrangThai")] TheLoai theLoai)
        {
            if (ModelState.IsValid)
            {
